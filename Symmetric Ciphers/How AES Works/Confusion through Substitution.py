...
sub_bytes(state, sbox=inv_s_box) 
 #the state reveals the position of the list that we have to take. so we do what they descibed and then we convert the elements of the inv_s_box that we take(only 
#the ones that are in the positions that the state box says) into their ascii characters.
